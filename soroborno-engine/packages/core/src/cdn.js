 ...
 */
export function resolveCdnUrl(fontId, fileName, customCdn) {
 ...
 */
export function getFontUrl(font, options = {}) {
    ...
    let variant = font.variants.find(v => v.weight === targetWeight && v.style === targetStyle);
    if (!variant) {
 ...
 */
export function getFontStylesheetUrl(fontId, customCdn) {
